...
得到初步特征
  ↓ 经过 layer1
继续提取特征
  ↓ 经过已经定义好的 self.layer2
得到 c3
  ↓ 经过已经定义好的 self.layer3
得到 c4
  ↓ 经过已经定义好的 self.layer4
得到 c5
最后返回：
return [c3, c4, c5]
...
用 3 层 MLP，把每个 query 的特征变成 4 个框坐标：
cx, cy, w, h
